  ...
  logger.section('Listing Count vs 200-Row Fetch Cap');
  {
    ...
    if (metrics.invisibleListings > 0) {
      ...
      issues.push({
        ...
        rootCause: 'BUG 4: app.js H.fetchListingsFromSupabase() hard-codes .limit(50). As the marketplace grows, the oldest listings (beyond position 200, ordered by created_at DESC) will never appear in any feed, search, or category page.',
        fix: {
          type: 'javascript',
          file: 'www/js/app.js',
