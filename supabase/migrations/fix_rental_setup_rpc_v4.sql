-- fix v4: rental_setup_company — use correct column name 'about' (not 'bio')
...
begin
  ...
  -- column is 'about', not 'bio'
  insert into rental_company_profiles (company_id, about)
  values (v_comp_id, p_bio)
  on conflict (company_id) do update set about = excluded.about;
