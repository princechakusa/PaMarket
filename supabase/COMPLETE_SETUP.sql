-- ═══════════════════════════════════════════════════════════════
-- PaMarket — COMPLETE database setup (flattened, runnable in the
-- Supabase SQL Editor). Safe to re-run. Creates every table, RLS
-- policy and storage bucket the app uses.
-- ═══════════════════════════════════════════════════════════════
...
-- ╔══ migrations/add_job_questions.sql ═════════════════════════════════════
...
-- ╔══ migrations/add_verification_storage.sql ═════════════════════════════════════
...
-- ╔══ migrations/add_deletion_persistence.sql ═════════════════════════════════════
