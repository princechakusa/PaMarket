(function(root,factory){
  ...
  function fetchListingCount(opts){opts=(typeof opts==='string')?{category:opts}:(opts||{});var qp=filters(opts);qp.push('select=id');return transport.exactCount('listings?'+qp.join('&'));}
