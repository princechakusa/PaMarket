  ...
  pages.About = function () {
    ...
    return `<div class="page active">
      ...
      <div style="background:linear-gradient(135deg,#1A3A8F 0%,#2952cc 100%);padding:36px 20px 32px;text-align:center">
        ...
        <div style="font-size:11px;color:rgba(255,255,255,.4);margin-top:18px;font-weight:600">v1.27.14</div>
      </div>
      ...
      <div class="doc-content" style="padding-top:4px">
        ...
        <div style="text-align:center;padding:32px 0 8px">
          ...
          <div style="font-size:11px;color:var(--text-hint,#bbb);margin-top:4px">v1.27.14 · Built with care for Zimbabwe</div>
        </div>
      </div>
    </div>`;
  };
