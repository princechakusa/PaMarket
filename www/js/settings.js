  ...
  pages.Settings = function () {
    ...
    return `<div class="page active">
      ...
      <div class="settings-section">
        ...
        <button class="settings-item" onclick="H.openInner('LegalHub')">
          <span class="item-icon"><svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></svg></span>
          <span class="item-label">Legal Hub</span>
          <span class="item-arrow">›</span>
        </button>
      </div>
