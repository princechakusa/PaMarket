  ...
  pages.AccountHub = function () {
    ...
    return `<div class="page active">
      ...
      <div style="margin-top:12px">
        ...
        ${row('<svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></svg>', 'Legal Hub', 'LegalHub', '')}
      ...
      <div style="padding:20px 16px 36px">
        ...
        <div style="text-align:center;margin-top:20px;font-size:11px;color:var(--sub);line-height:1.8">
          ...
          <span style="font-size:10px;color:var(--sub2,#bbb)">All rights reserved · <span onclick="H.openInner('LegalHub')" style="cursor:pointer;text-decoration:underline">Legal Hub</span> · <span onclick="H.openInner('HelpTerms')" style="cursor:pointer;text-decoration:underline">Terms</span> · <span onclick="H.openInner('HelpPrivacy')" style="cursor:pointer;text-decoration:underline">Privacy</span></span>
        </div>
      </div>
    </div>`;
  };
