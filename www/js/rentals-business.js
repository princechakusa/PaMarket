  ...
  RB._fleetMore = function (vehicleId, bizId, toggleStatus) {
    ...
    H.modal({
      ...
      body: `<div style="display:flex;flex-direction:column;gap:8px">
        ...
        <button onclick="H.closeModal();H.featureRentalListing('${esc(vehicleId)}')" style="width:100%;padding:12px;background:linear-gradient(135deg,#1A3A8F,#2952cc);border:none;border-radius:12px;font-size:14px;font-weight:700;color:#fff;cursor:pointer;font-family:inherit;text-align:left">Feature this Listing</button>
