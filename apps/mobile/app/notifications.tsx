...
const styles = StyleSheet.create({
  ...
  actionLink: { fontSize: 13, fontWeight: "700", color: BRAND_BLUE },
  actionLinkDanger: { color: "#C0392B" },
  sectionHeader: {
    fontSize: 12,
    fontWeight: "700",
    color: "#8A93A6",
  ...
  rowUnread: { borderLeftWidth: 3, borderLeftColor: BRAND_BLUE },
  dot: { width: 8, height: 8, borderRadius: 4, marginTop: 6 },
  title: { fontSize: 14, fontWeight: "700", color: "#111827" },
  body: { fontSize: 13, color: "#5A6478", marginTop: 3, lineHeight: 18 },
  time: { fontSize: 11, color: "#8A93A6", marginTop: 6 },
});
