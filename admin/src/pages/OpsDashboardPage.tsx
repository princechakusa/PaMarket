...
export function OpsDashboardPage() {
  ...
  return <div className="ops-dashboard">
    ...
    <section className="analytics-grid">
      ...
      <article className="ops-panel geo"><header className="panel-title"><div><span className="material-symbols-outlined">public</span><h2>Provincial Activity Grid</h2></div><span>LIVE GEO VIEW</span></header><div className="map-grid"><span className="map-outline">ZW</span><i className="pin one"/><i className="pin two"/><i className="pin three"/><span className="map-code">HRE 54%</span></div><div className="geo-list"><div><i className="green"/>Harare Metro <strong>54.0% ($742K Vol)</strong></div><div><i className="orange"/>Bulawayo Metro <strong>24.0% ($330K Vol)</strong></div><div><i className="mint"/>Manicaland <strong>8.0% ($110K Vol)</strong></div><div><i/>Midlands & Other <strong>14.0% ($136K Vol)</strong></div></div></article>
    </section>
