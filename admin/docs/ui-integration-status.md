...
One of the twelve supplied main pages still needs UI implementation: Roles & Permissions. Additional admin subpages are outside this twelve-page count. Security Settings and authentication/MFA have separate existing implementations.
